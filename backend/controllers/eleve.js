...
exports.modifyEleve = async (req, res, next) => {
  try {
    ...
    const newRemainingClasses = eleve.remainingClasses + Number(req.body.remainingClasses);
...
exports.deleteEleve = async (req, res) => {
  try {
      ...
      const result = await Eleve.findByIdAndDelete(new mongoose.Types.ObjectId(id)); // Convertir en ObjectId
      console.log('ID reçu pour suppression:', id);
